...
# This class is used to create new node for Doubly linked list
class Node:
...
# This class is used to handle all functionalilty of Doubly linked list
    ...
    def insertAtNumber(self, data, number=0):
        ...
        if number == cnt:
            ...
            if temp.NextNode == None:
                ...
                temp.NextNode = self.newNode
                self.newNode.PrevNode = temp
                temp = self.newNode.NextNode
                temp.PrevNode = self.newNode
